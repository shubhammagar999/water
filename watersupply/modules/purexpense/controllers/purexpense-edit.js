// import admin
angular.module('purexpense').controller('purexpenseEditCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route, $filter, hotkeys) {

  $('.index').removeClass("active");
  $('#menuvendorindex').addClass("active");
  $('#purexpenseindex').addClass("active");
  ...
  hotkeys.bindTo($scope).add({
    combo: 'alt+s',
    description: 'It will update creditors payment entry.',
    ...
    $scope.getExpenseList = function() {
        $scope.apiURL = $rootScope.baseURL+'/purexpense/'+$scope.expenseId;
        $http({
          method: 'GET',
          url: $scope.apiURL,
    ...
    $scope.addExpense = function () {
        ...
        if($scope.expense.em_payment_mode == undefined || $scope.expense.em_payment_mode == ""){
        ...
        else if($('#vm_id').val() == undefined || $('#vm_id').val() == "" || $scope.expense.em_vm.vm_id == undefined){
            var dialog = bootbox.dialog({
            ...
            $scope.apiURL = $rootScope.baseURL+'/purexpense/edit/'+$scope.expenseId;
            $http({
              method: 'POST',
              url: $scope.apiURL,
              data: $scope.expense,
