// import admin
angular.module('expense').controller('expenseEditCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route, $filter, hotkeys) {
  ...
  hotkeys.bindTo($scope).add({
    combo: 'alt+s',
    description: 'It will update debtors payment entry.',
    ...
    $scope.getExpenseList = function() {
        $scope.apiURL = $rootScope.baseURL+'/expense/'+$scope.expenseId;
        $http({
          method: 'GET',
          url: $scope.apiURL,
    ...
    $scope.addExpense = function () {
        ...
        // else if($('#cm_id').val() == undefined || $('#cm_id').val() == "" || $scope.expense.em_cm.cm_id == undefined){
        //     var dialog = bootbox.dialog({
        ...
        // }
            ...
            $scope.apiURL = $rootScope.baseURL+'/expense/edit/'+$scope.expenseId;
    	    $http({
    	      method: 'POST',
    	      url: $scope.apiURL,
    	      data: $scope.expense,
