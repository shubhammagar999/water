// import admin
angular.module('expense').controller('expenseAddCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route, hotkeys) {
  
  $('.index').removeClass("active");
  $('#menucustomerindex').addClass("active");
  $('#newexpenseindex').addClass("active");
  ...
  hotkeys.bindTo($scope).add({
    combo: 'alt+s',
    description: 'It will add a new debtors payment entry.',
  ...
  // };
      ...
      var searchTerms = {search: vals, com_id: localStorage.getItem("com_id")};
        ...
        return $http.post($rootScope.baseURL+'/dashboard/customerreport/typeahead/search', searchTerms, httpOptions).then((result) => {
  ...
  $scope.addExpense = function () {
        ...
        if($scope.expense.em_payment_mode == undefined || $scope.expense.em_payment_mode == ""){
        ...
        else if($('#cm_id').val() == undefined || $('#cm_id').val() == "" || $scope.expense.em_cm_id.cm_id == undefined){
            var dialog = bootbox.dialog({
            ...
            setTimeout(function(){
                ...
                $scope.expense.em_cm_id.cm_debit = $scope.expense.em_cm_id.debit;
                $scope.expense.em_cm_id.cm_balance = $scope.expense.em_cm_id.credit;
