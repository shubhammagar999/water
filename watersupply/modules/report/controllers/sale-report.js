// import admin
angular.module('report').controller('saleReportCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route, $filter) {
...
$scope.apiURL = $rootScope.baseURL+'/dashboard/salereport/total';
   ...
   //Pagination Function
    ...
    //   $scope.searchtext = $scope.searchtextoption;
    //   $scope.getAll();
    // };
  ...
  $scope.viewSaleDetailsOLD = function (index) {
