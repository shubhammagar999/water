...
ALTER TABLE time_dimension ADD CONSTRAINT time_dimension_date_dim_id_pk PRIMARY KEY (date_dim_id);

CREATE INDEX time_dimension_date_actual_idx ON time_dimension(date_actual);
