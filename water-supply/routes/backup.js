...
router.post('/', oauth.authorise(), (req, res, next) => {
    ...
    var filepath = "/usr/share/3ct-cloth/backup/"+filename+".sql";
    cmd.get("pg_dump --dbname=postgresql://postgres:zeartech@localhost:5432/3ctcloth > backup/"+filename+".sql --role postgres --format=c --blobs --encoding SQL_ASCII",
    function(err, data, stderr){
        if (!err) {
	        ...
	        let mailOptions = {
	            ...
	            subject: 'backup database file of 3CT Cloth', // Subject line
